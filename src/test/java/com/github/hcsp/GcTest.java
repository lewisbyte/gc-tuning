...
public class GcTest {
    ...
    // 请不要调整-Xms和-Xmx
    private static final String JVM_ARGS = "-Dfile.encoding=UTF-8 -Xms256m -Xmx256m -XX:-UseAdaptiveSizePolicy -XX:NewSize=170m -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:+PrintGCTimeStamps";
