...
public class GcTest {
    ...
    // 请不要调整-Xms和-Xmx
    //-XX:+PrintHeapAtGC
    private static final String JVM_ARGS = "-Dfile.encoding=UTF-8 -Xms256m -Xmx256m -Xmn192m -XX:SurvivorRatio=1 -XX:-UseAdaptiveSizePolicy -XX:+PrintHeapAtGC -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:+PrintGCTimeStamps";
