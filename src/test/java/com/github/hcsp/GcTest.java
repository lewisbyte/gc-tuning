...
public class GcTest {
    ...
    // 请不要调整-Xms和-Xmx
    private static final String JVM_ARGS = "-Dfile.encoding=UTF-8 -XX:-UseAdaptiveSizePolicy -XX:InitialSurvivorRatio=4 -Xms256m -Xmx256m -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:+PrintGCTimeStamps";
